...
async.series([
  function(next) {
    ...
    function readUInt64LEBN() {
      ...
      var buf = buffers[c];
      var br = new hthcore.encoding.BufferReader(buf);
  ...
  function(next) {
    ...
    function bitcoreTest() {
      block1 = hthcore.Block.fromString(blockData);
    }
    ...
    var suite = new benchmark.Suite();
    suite.add('hthcore', bitcoreTest, {maxTime: maxTime});
